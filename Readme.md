...
# Parsing + Configuration Script – RAK2270 - Rev. A

This **Parsing + Configuration** script is designed for the **RAK2270** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – RAK2270 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **RAK2270** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
